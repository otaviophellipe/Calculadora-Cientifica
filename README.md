...
Cálculo de raiz quadrada e potências

Funções de arredondamento

Suporte a parênteses para priorizar operações

Memória para armazenar e reutilizar resultados
...
2 - Clone este repositório:
   ```bash
   git clone https://github.com/otaviophellipe/calculadora-cientifica
