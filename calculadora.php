...
<head>
    ...
    <style>
        ...
        .greybutton { background: #6c757d; }
        .blackbutton { background: #393e46; }
        .bluebutton { background: #00adb5; }
        .greenbutton { background: #21bf73; }
        .redbutton { background: #ff2e63; }
        .button:not(.redbutton):hover {
...
<body>
            ...
            <tr>
                <td>
                    <div class="displaytable-cell" id="bPi">
                        <button class="button greenbutton" type="button" onclick="calculadora.writeMathFunction('PI')">π</button>
                    </div>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <div class="displaytable-cell" id="bFactorial">
                        <button class="button greenbutton" type="button" onclick="calculadora.calculateFactorial()">n!</button>
                    </div>
                </td>
                <td>
    ...
    <aside id="sidebar">
        ...
        <h3 style="align-self: center; color: white; margin: 0;">Code By:</h3>
        <a href="https://www.linkedin.com/in/otaviophellipe" target="_blank" title="LinkedIn">
        ...
        <a href="https://github.com/otaviophellipe" target="_blank" title="GitHub">
            <button class="sidebar-button">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="white">
